...
echo_and_run cd "/home/rhouck/hydros_ws/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/rhouck/hydros_ws/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/rhouck/hydros_ws/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
