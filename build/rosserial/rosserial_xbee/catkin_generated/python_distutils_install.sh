...
echo_and_run cd "/home/rhouck/hydros_ws/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/rhouck/hydros_ws/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/rhouck/hydros_ws/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
